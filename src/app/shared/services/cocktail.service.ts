...
initCocktails(): void{
  this.http.get<Cocktail[]>('https://cocktails-3ce09.firebaseio.com/cocktails.json').subscribe( 
    ( cocktails: Cocktail[] )=> {
  ...
  getCoctail(index: number): Observable<Cocktail>{
  ...
  save(): void{
    this.http.put('https://cocktails-3ce09.firebaseio.com/cocktails.json', this.cocktails.value).subscribe();
  }
